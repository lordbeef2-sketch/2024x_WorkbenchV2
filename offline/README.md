...
- embeds the complete source-attributed 3DS 2024x KB used by Workbench Agent;
...
Prep discovers the canonical builder output automatically. Use
`-KnowledgeBasePath C:\approved\nomagic_owui_kb` to select a different verified
export. Prep stops instead of producing an Agent-incomplete bundle when the KB
or its manifest is missing.
...
- copies the new app, frontend, and KB into an install-local staging directory
